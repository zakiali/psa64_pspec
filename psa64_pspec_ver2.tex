...
We then calibrate on the basis of redundancy before using self-calibration to solve
for absolute phase and gain parameters. After suppressing foregrounds with a
...
\ref{fig:fringe_rate_cut} shows a cut of the optimal fringe-rate filter at 159 MHz for
...
\subsubsection{Review of Optimal Quadratic Estimators}
...
\subsubsection{Application of Optimal Quadratic Estimators}
\label{sec:oqe_app}
...
consideration. Therfore, combining equations \ref{XXX} and \ref{XXX} we get that the
the maximum value of the prefactor in \ref{eqn:d2pspec_model} is given by 
\begin{equation}
