...
fringe-rate bins on the sky by the r.m.s. of the beam at that same location.
...
fringe rates below 0.2 millihertz. This effects a crosstalk filter by removing
the slowly varying signals that we model our crosstalk as. We convolve the
time-domain visibilitieswith the Fourier transform of the resulting fringe-rate
...
There is an associated signal loss with this fringe-rate filter.  As shown in
Table \ref{tbl:sigloss}, we find that there is a 39\% signal loss due to the
fringe-rate filter described here.
...
[XXX check integration time for new filter. getting 1586s.]
