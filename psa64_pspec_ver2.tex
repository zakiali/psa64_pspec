...
%       --Do calculations.
%       --Fringe rate filtering is evvectively a weighted average in time and
...
%         baselines depends on the average in time and if there is enough
%         information to invert covariance matricies. 
...
%       --In addition, inverting this full covariance matrix is also problematic
%         because of the shear amount of redundancy in our measurements. Every
%         baseline is the same. Leading to a singular covariance matrix. 
...
%         loss. 
%   -Simulations
%       --In order to show the degree that there could be signal was we run
