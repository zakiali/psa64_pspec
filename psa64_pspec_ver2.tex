...
sources do not move and have static fringe rates \citep{parsons_backer2009}. We
then compute the average beam response for each contour of constant fringe rate
to construct our time average kernel or "fringe rate filter".
...
power spectrum baselines in question (30 m East-West baselines), the effective
...
measured over 135 days with every redundant east-west 30-m baseline at 149.5
...
[XXXthis bit needs work.. what was I trying to say with this?]
...
understand the application of this quadratic estimator foramlism to the data,
...
which will have the sensitiviy to make a $30\sigma$ detection of the 21 cm power
