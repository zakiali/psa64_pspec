...
Gianni XXX Bernardi\altaffilmark{3}, 
Chris L.  Carilli\altaffilmark{8},
Carina T. Cheng\altaffilmark{1},
David R. DeBoer\altaffilmark{2}, 
Matthew R. Dexter\altaffilmark{2},
Steve XXX Furlanetto\altaffilmark{XXX},
Daniel C. Jacobs\altaffilmark{9}, 
Pat XXX Klima\altaffilmark{6},
Adrian C. Liu\altaffilmark{1}, 
...
baselines. only use cross correlations between baselines on either side of the
the $\mathbf{Q}$ matrix. [XXX is this true]
...
bin. Therefore, because we are using only the auto covariances to  In the per baseline application, the optimal quadratic
estimator becomes 
...
[XXX: need to put in correction factor that accounts for filtering of 3 sigma mediaan. This will remove the discussion below of the redubdant baselinees and discrepencies with old estimates.]
