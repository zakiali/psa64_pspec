...
%       the k-modes. 
%       --Some other choices of the window functions are the sqare root of the
%       fisher matrix or the identity. 
%       --We use the cholesky decomposition of the Fisher Matrix such that we
%       can wrtie F = LL^{\dagger}, where L is a lower triangular matrix. This
...
%       modes lower than it. 
%       --This is particularily important becasue it doesn't insures that there
...
%
%   -Boot strapping 
%       --We bootstrap our errors over all the separation types. 
%
%   -PLOTS:
