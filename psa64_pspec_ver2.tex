...
leads to models of the covaraince matrix that overfit to the noise. Hence, when used in conjuction with the
...
the signal loss, we simulate visibilities for spatially Guassian signal with a
