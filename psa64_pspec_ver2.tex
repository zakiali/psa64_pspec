...
that should be down-weighted, for example, but if the covariances are dominated
by noise, this may just be a random fluctuation and that mode may not need to
be down-weighted. Said differently, the weighting of the data by the inverse
...
In order to accurately describe the covariance matrix of the instrument, we would require complete knowledge of the sky signal and the instrument and the interaction of the two due to the chromaticity of the interferometer.
...
spectrum of the simulated visibilities, interpreted as signal loss through the
quadratic estimator of the power spectrum.  
