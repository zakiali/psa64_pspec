...
converters digitize and channelize antenna inputs. New to this correlator, compared to prior PAPER correlators \citep{parsons_et_al2010},
...
derived analytically (\citealt{liu_et_al2014a}; \citealt{liu_et_al2014b}; P12b; \citealt{vedantham_et_al2012}), and has been confirmed in 
simulations \citep{hazelton_et_al2013,datta_et_al2010} and observationally
\citep{dillon_et_al2013b,pober_et_al2013}.  As described in P12b, the wedge is the result of the delay
...
wide-band delay filter (Section \ref{sec:wbd_filtering}), we apply additional RFI flagging and 
average the data in LST (Section \ref{sec:lstbin}). We then apply a 
fringe-rate filter (Section \ref{sec:frf}) to optimally combine the time-domain data and remove crosstalk.
Finally, we use an
...
calibration parameters to be solved for on the basis of redundancy (\citealt{marthi_et_al2014}; P14; \citealt{noorishad_et_al2012}; P12a; 
