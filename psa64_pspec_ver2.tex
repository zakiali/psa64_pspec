...
for redundancy-based calibration \citep{liu_et_al2011,wieringa1992,zheng_et_al2014}, on which PAPER
...
\begin{equation}\label{eqn:presum_oqe}
    \mathbf{z}^{r}_{A} = \Sigma_{i\in{A}} \mathbf{C}_{i}^{-1}\mathbf{x}_{i},
\end{equation}
where
