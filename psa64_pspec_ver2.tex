...
\end{equation}
where $V_{i}(t,\tau)$ is the delay transform of baseline visibilities, $X$ and
$Y$ are constants that convert from angles and frequency to the co-moving
...
before squaring and multiplying by a scalar. Thus, the role of $\mathbf{Q}_\alpha$ Equation \eqref{eqn:presum_qalpha} is to perform a frequency Fourier transform on each copy of
...
of foregrounds out of the wedge. Additionally, our placement of the highest $k$ bin as the third element in our reordering of 
