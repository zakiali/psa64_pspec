...
due to the fact that it the frequency of observed radiation maps to a specific
redshift. It has the potential to map the never before seen dark ages
($z\tilde{30}$), where the first galaxies and stars were beginning to form, as
...
initial inflation power spectrum, amongst other cool science. Using 21 cm to map
the universe has the ability to surpass the Cosmic Microwave Background (CMB) in
terms of the wealth of science it can deliver. Refer to
\cite{furlanetto_et_al2006}, \cite{morales_wyithe2010}, and
...
In addition to using the 21 cm transtion as a probe of the early universe, and
specifically EoR, the CMB and the Gunn-Peterson effect can also be used to
constrain reionization. The Gunn-Peterson effect toward distant quasars gives
the constraint that the intergalactic medium (IGM) was fully ionized by $z=6$
(\cite{fan_et_al2006}). In addition, Planck results of the optical depth
parameter...
...
correlator cross correlates all 64 dual polarization antennas with 100 MHz of 
...
We rely on all 2016 baselines for the calibration procedure, but only use a
...
out. This leads to relative calibration solutions that relate the antennas
within the array. Hence, there needs to be a second round of calibration which
folds in information about the sky to solve for the absolution phases in order
correctly phase to sourcese on the celestial sphere. Redundant calibration
inherently preserves common mode signal between redundant baselines, and
therefore this type of calibration is necessarily lossless. 
...
using linear least square. We are fitting 
\begin{equation}
