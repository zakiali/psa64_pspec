...
Secondly, we use the data from the even and odd LST binned data sets which were created
by binning alternate days onto the same LST grid. 
When constructing our estimate of the power
...
one another.  This contrasts with the power-spectrum estimator in P14, which
used a Blackmann-Harris taper function that reduced leakage between band powers,
but resulted in overlapping window functions that meant neighboring 
band powers contained correlated errors.
