...
east-west baselines (e.g. 41-47) and those of the same type except slanted up
and down one row (e.g. 10-41 and 10-58, respectively). Baselines in each of the
3 separation types (or redundant groups) are instantaneously redundant within
the group and therefore measure the same fourier modes on the sky. This allows
us to coherently add fourier modes, building sensitivity as $N$  rather than
$\sqrt{N}$.
