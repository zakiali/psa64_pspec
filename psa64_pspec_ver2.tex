...
\begin{table}[htdp]
\caption{SIGNAL LOSS ANALYSIS STAGES}
\begin{center}
\begin{tabular}{rll}
Analysis Step & Typical Loss & Maximum Signal Loss \\ \hline
Flux Scale Calibration &  $\ll 2 \times 10^{-7}$ \% & 3\% \\
Delay Filtering & 4.8\% & .0015\% \\
Quadratic Estimator & XXX & 100\% \\
\end{tabular}
\end{center}
\label{tbl:sigloss}
\end{table}%
