...
it takes a source to transit through one period of a fringe 
from a 30-m baseline at 150 MHz.  Because
...
line-of-sight Fourier modes, which holds for the short 30 m baselines used in this
...
applying the analysis to different redundant baselines separately. In the
description what follows we use the east-west 30 meter redundant baselines (
baselines $49\_41$, $41\_47$, $10\_3$, etc. in figure
\ref{fig:antenna_positions}), but we apply the same analysis to each of the 30-m
baselines with one row spacings (10-41,9-3,3-47,\dots  and 49-3,10-58,41-25,\dots
antennas in figure \ref{fig:antenna_positions}), combining the final power
spectra in the bootstrapping after estimating power spectra.  Focusing on the 30-m
east-west redundant baselines, our data vector becomes a list of visibilities
such that
\begin{equation}
\label{eqn:xvectdef}
...
redundant groups of baseline corresponding to 30-m east west components and 5 m
(a row spacing) in the north and south direction. There is enough variation in
