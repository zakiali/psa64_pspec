...
redundancy configuration. This paper is outlined as follows. In section
...
\section{Optimal Fringe-Rate Filter}\label{sec:frf}
...
\section{Optimal Quadratic Estimator and Covariance}\label{sec:oqe}
...
colors represent both positive negative $k$'s with green curves haveing the
