...
a model EoR signal. We construct a model baseline visibility as a Gaussian
...
$k$-mode, we compare the power spectra from the output of the simulated EoR
signal to the input amplitude in and find that between $-.06 < k < .06$, the
