...
#    limits['.492'] = (0.492, 2083.53, 2562.52, 'k')
    ...
    limits['.197'] = (0.197, 282.44, 146.93, 'k')
    limits['.246'] = (0.246, 65.11, 184.17, 'k')
    limits['.295'] = (0.295, 578.22, 258.92, 'k')
    limits['.345'] = (0.345, 518.86, 401.22, 'k')
    limits['.394'] = (0.394, -452.46, 652.50, 'k')
    limits['.443'] = (0.443, 182.64, 717.59, 'k')
    limits['.492'] = (0.492, 216.15, 1071.91, 'k')
