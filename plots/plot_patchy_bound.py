...
#    limits['.492'] = (0.492, 2083.53, 2562.52, 'k')
    ...
    limits['.197'] = (0.197, 187.95, 206.34, 'k')
    limits['.246'] = (0.246, 104.66, 279.77, 'k')
    limits['.295'] = (0.295, 1016.62, 425.47, 'k')
    limits['.345'] = (0.345, 415.66, 657.13, 'k')
    limits['.394'] = (0.394, 945.30, 950.17, 'k')
    limits['.443'] = (0.443, 3774.72, 1318.15, 'k')
    limits['.492'] = (0.492, 2316.0, 1603.88, 'k')
